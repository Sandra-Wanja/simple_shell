...
/**
 * _unsetenv - Unsets (removes) an environment
 * variable from the shell's environment.
 * @info: A pointer to the shell information struct
 * @var: The name of the environment variable to unset
 *
 * Return: 1 if the environment changed, 0 otherwise
 */
...
/**
 * _setenv - Sets (adds or modifies) an environment
 * variable in the shell's environment.
 * @info: A pointer to the shell information struct
